...
$filteredProductListHTML = History::getHistorySellProductFilteredOrdered($db, $session->getId(), $namesearch, $datesearch, $minprice, $maxprice, $orderquerry);

$users = [];

foreach ($filteredProductListHTML as $sell) {
